...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Problem clarity
    "problem_clarity.question": "How well do you understand the problem?",
    "problem_clarity.tip":
      "Think about what the problem is, who faces it, and what makes it difficult for them.",
    "problem_clarity.option.1": "I'm still exploring the problem",
    "problem_clarity.option.2": "I have a general idea",
    "problem_clarity.option.3": "I know the specific problem",
    "problem_clarity.option.4": "I know who faces it",
    "problem_clarity.option.5": "I understand the pain deeply",
    ...
    "customer_pain_evidence.option.1": "I haven't checked yet",
    "customer_pain_evidence.option.2": "I've talked to a few people",
    "customer_pain_evidence.option.3": "I have real feedback or data",

    // Product
    "product_maturity.question": "What have you built so far?",
    "product_maturity.tip":
      "Tell us what someone can actually see, try, or use today.",
    "product_maturity.option.1": "Just an idea",
    "product_maturity.option.2": "I have a prototype or MVP",
    "product_maturity.option.3": "People can use it now",

    // Traction
    "traction.question": "Are people using it yet?",
    "traction.tip":
      "Users, testers, pilot users, or paying customers all count.",
    "traction.option.1": "Not yet",
    "traction.option.2": "A few people are trying it",
    "traction.option.3": "People are using or paying for it",

    // Revenue
    "revenue_model_clarity.question": "How will you make money?",
    "revenue_model_clarity.tip":
      "Tell us how you plan to charge customers or earn revenue.",
    "revenue_model_clarity.option.1": "I haven't decided yet",
    "revenue_model_clarity.option.2": "I have a basic plan",
    "revenue_model_clarity.option.3": "I know how I'll charge",

    // Market
    "market_size_evidence.question": "How big could this opportunity be?",
    ...
    "market_size_evidence.option.1": "I don't know yet",
    "market_size_evidence.option.2": "I have a rough idea",
    ...
    "team_completeness.option.1": "I'm missing some skills",
    "team_completeness.option.2": "We have some of them",
    "team_completeness.option.3": "We have the key skills",
    ...
    "competitive_differentiation.option.1": "I'm not sure yet",
    "competitive_differentiation.option.2": "I have some differences",
    "competitive_differentiation.option.3": "I have a clear advantage",

    // Shared options
    "skip.not_sure": "I'm not sure yet",
    "skip.not_applicable": "Not applicable to my venture",

    // Acknowledgments
    "ack.strong": "That's strong evidence — noted.",
    "ack.starting": "Good — that's a real starting point.",
    "ack.negative":
    ...
    "idea.error.name": "Give it a name before we continue.",
    "idea.error.description":
      "Say a little more — at least {min} characters.",
  },

  ta: {
    "idea.opening.question": "நீங்கள் என்ன உருவாக்குகிறீர்கள்?",
    "idea.opening.label": "நீங்கள் என்ன உருவாக்குகிறீர்கள்?",
    "idea.opening.placeholder":
      "உணவு கெட்டுப்போவதை முன்கூட்டியே கணிக்கும் உணவக சரக்கு மேலாண்மை கருவி…",
    "idea.opening.nameQuestion": "இதற்கு நான் என்ன பெயர் வைக்க வேண்டும்?",
    "idea.opening.nameLabel": "இதற்கு என்ன பெயர் வைக்க வேண்டும்?",
    "idea.opening.namePlaceholder": "WasteLess Kitchen",
    ...
    "problem_clarity.option.2": "எனக்கு ஒரு பொதுவான யோசனை உள்ளது",
    ...
    "customer_pain_evidence.option.1": "நான் இன்னும் சரிபார்க்கவில்லை",
    "customer_pain_evidence.option.2": "நான் சிலரிடம் பேசியுள்ளேன்",
    ...
    "product_maturity.option.1": "ஒரு யோசனை மட்டுமே",
    ...
    "traction.option.1": "இன்னும் இல்லை",
    "traction.option.2": "சிலர் முயற்சி செய்து வருகின்றனர்",
    "traction.option.3":
    ...
    "revenue_model_clarity.option.1": "இன்னும் முடிவு செய்யவில்லை",
    ...
    "market_size_evidence.option.1": "இன்னும் தெரியவில்லை",
    ...
    "skip.not_sure": "எனக்கு இன்னும் உறுதியாகத் தெரியவில்லை",
    "skip.not_applicable": "என் முயற்சிக்கு இது பொருந்தாது",

    "ack.strong": "இது வலுவான ஆதாரம் — பதிவு செய்துகொண்டோம்.",
    "ack.starting": "நல்லது — இது ஒரு நல்ல தொடக்கம்.",
    "ack.negative":
  ...
  te: {
    "idea.opening.question": "మీరు ఏమి నిర్మిస్తున్నారు?",
    "idea.opening.label": "మీరు ఏమి నిర్మిస్తున్నారు?",
    "idea.opening.placeholder":
      "ఆహారం పాడవడాన్ని ముందుగానే అంచనా వేసే రెస్టారెంట్ ఇన్వెంటరీ సాధనం…",
    "idea.opening.nameQuestion": "దీనికి నేను ఏమని పేరు పెట్టాలి?",
    "idea.opening.nameLabel": "దీనికి ఏమని పేరు పెట్టాలి?",
    "idea.opening.namePlaceholder": "WasteLess Kitchen",
    ...
    "problem_clarity.option.2": "నాకు సాధారణ అవగాహన ఉంది",
    "problem_clarity.option.3": "నాకు నిర్దిష్ట సమస్య తెలుసు",
    "problem_clarity.option.4":
    ...
    "customer_pain_evidence.option.1": "నేను ఇంకా పరిశీలించలేదు",
    "customer_pain_evidence.option.2": "నేను కొంతమందితో మాట్లాడాను",
    "customer_pain_evidence.option.3":
    ...
    "product_maturity.option.1": "ఒక ఆలోచన మాత్రమే",
    "product_maturity.option.2":
    ...
    "traction.option.1": "ఇంకా లేదు",
    "traction.option.2": "కొంతమంది ప్రయత్నిస్తున్నారు",
    "traction.option.3":
    ...
    "revenue_model_clarity.option.1": "నేను ఇంకా నిర్ణయించలేదు",
    "revenue_model_clarity.option.2":
    ...
    "market_size_evidence.option.1": "నాకు ఇంకా తెలియదు",
    "market_size_evidence.option.2": "నాకు ఒక అంచనా ఉంది",
    "market_size_evidence.option.3":
    ...
    "skip.not_sure": "నాకు ఇంకా ఖచ్చితంగా తెలియదు",
    "skip.not_applicable": "నా వెంచర్‌కు ఇది వర్తించదు",

    "ack.strong": "అది బలమైన సాక్ష్యం — నమోదు చేసుకున్నాం.",
    "ack.starting": "మంచిది — ఇది మంచి ప్రారంభం.",
    "ack.negative":
  ...
  hi: {
    "idea.opening.question": "आप क्या बना रहे हैं?",
    "idea.opening.label": "आप क्या बना रहे हैं?",
    "idea.opening.placeholder":
      "एक रेस्तरां इन्वेंटरी टूल जो खाना खराब होने से पहले उसका अनुमान लगाता है…",
    "idea.opening.nameQuestion": "और मुझे इसे क्या नाम देना चाहिए?",
    "idea.opening.nameLabel": "मुझे इसे क्या नाम देना चाहिए?",
    "idea.opening.namePlaceholder": "WasteLess Kitchen",
    ...
    "problem_clarity.option.2": "मेरे पास एक सामान्य विचार है",
    "problem_clarity.option.3": "मुझे समस्या स्पष्ट रूप से पता है",
    "problem_clarity.option.4": "मुझे पता है कि इसे कौन झेलता है",
    "problem_clarity.option.5":
    ...
    "product_maturity.question": "आपने अब तक क्या बनाया है?",
    "product_maturity.tip":
      "बताएं कि आज कोई व्यक्ति वास्तव में क्या देख, आज़मा या इस्तेमाल कर सकता है।",
    "product_maturity.option.1": "सिर्फ एक विचार",
    "product_maturity.option.2": "मेरे पास Prototype या MVP है",
    "product_maturity.option.3":
      "लोग इसे अभी इस्तेमाल कर सकते हैं",

    "traction.question": "क्या लोग इसे इस्तेमाल कर रहे हैं?",
    "traction.tip":
      "यूज़र्स, टेस्टर्स, पायलट यूज़र्स या भुगतान करने वाले ग्राहक सभी गिने जाते हैं।",
    "traction.option.1": "अभी नहीं",
    "traction.option.2": "कुछ लोग इसे आज़मा रहे हैं",
    "traction.option.3":
    ...
    "market_size_evidence.option.1": "मुझे अभी पता नहीं है",
    "market_size_evidence.option.2":
    ...
    "team_completeness.option.2": "हमारे पास कुछ कौशल हैं",
    "team_completeness.option.3": "हमारे पास मुख्य कौशल हैं",
    ...
    "skip.not_sure": "मुझे अभी यकीन नहीं है",
    "skip.not_applicable": "मेरे वेंचर पर लागू नहीं होता",

    "ack.strong": "यह मजबूत प्रमाण है — नोट कर लिया।",
    "ack.starting": "अच्छा — यह एक अच्छी शुरुआत है।",
    "ack.negative":
