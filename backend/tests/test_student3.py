...
def test_student3_outputs_are_grounded_and_do_not_claim_traction():
    funding = assess_funding_readiness({"problem_clarity": {"state": "confirmed_positive", "severity": 2}})
...
def test_ranking_changes_when_inputs_change():
    funding = assess_funding_readiness({
        ...
        "traction": {"state": "confirmed_positive", "severity": 1},
    })
    ...
    richer_funding = assess_funding_readiness({
        "problem_clarity": {"state": "confirmed_positive", "severity": 2},
