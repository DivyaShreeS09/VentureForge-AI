    ...
    *,
    ...
    return {
        ...
        "source_attribution": {
            ...
            "customer_segment": "deterministic segment fallback from model/rubric evidence" if customer_segment else "not available",
            "ranked_actions": "versioned deterministic ranking rules",
            "risks": "fixed planning-risk templates grounded in readiness evidence",
        },
        "evidence_categories": {
            "verified_evidence": ["startup name, description, and submitted funding answers"],
            "model_inference": ["industry prediction"] if industry_prediction else [],
            "deterministic_assessment": ["funding readiness", "customer segment", "ranked actions", "risks"],
