"""Strict, source-labelled contracts for the Phase 5 (Student 3) deterministic planning modules —
see app.agents.student3. Every model forbids extra fields so a malformed payload fails validation
